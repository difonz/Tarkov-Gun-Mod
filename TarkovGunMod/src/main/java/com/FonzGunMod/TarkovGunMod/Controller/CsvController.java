...
import com.FonzGunMod.TarkovGunMod.csvHelpers.CSVService;
import com.FonzGunMod.TarkovGunMod.csvHelpers.CSVHelper;
import com.FonzGunMod.TarkovGunMod.Message.ResponseMessage;
...
public class CSVController {
    ...
    public ResponseEntity<List<Weapons>> getAllWeapons() {
        try {
            List<Weapons> weapons = fileService.getAllWeapons();
